...
CREATE TABLE unidade (
    idUnidade int auto increment PRIMARY KEY,
    nome varchar(20) not null,
    centro varchar(3) enum('sim','não') default 'não',
...
CREATE TABLE pessoa (
    ...
    idPessoa int auto increment PRIMARY KEY,
    fk_idEndereco int
);

CREATE TABLE endereco (
    idEndereco int auto increment PRIMARY KEY,
    cidade varchar(20),
    bairro varchar(20),
    numero int,
    rua varchar(20),
...
CREATE TABLE lote (
    lote int auto increment PRIMARY KEY,
    data_validade date
);
...
CREATE TABLE movimento_estoque (
    ...
    quantidade int,
    tipo_transacao varchar(3) enum('rec','tra', 'apl'),
    fk_idPessoa int,
    fk_idUnidade int,
    fk_lote int,
